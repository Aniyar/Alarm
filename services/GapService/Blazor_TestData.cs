...
namespace GapService
{
    public class Blazor_ProfileData
    {
        ...
        public string cs = "Host=DESKTOP-EMAFC5J;Username=postgres;Password=alhafizu;Database=railway_comp";
        ...
        public bool FoundLeft { get; private set; }
        ...
        public bool CurrentProfileLeft(string filePath, int kmnum)
        {
            BinaryReader reader = in_koridor;
            {
                try
                {
                    ...
                    if (Kilometer == kmnum && FoundLeft == false)
                    {
                        FoundLeft = true;
                    }
                    if (Kilometer != kmnum && FoundLeft == true)
                    {
                        return false;
                    }
