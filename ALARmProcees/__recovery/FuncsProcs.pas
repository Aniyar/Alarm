 ...
 Fm[0] :=0;
  ...
  begin
    ...
    begin
      ...
      Setlength(transitions, tran_length + 1);
      transitions[tran_length] := i;
      if (abs(Fm[i] ) <0.0) then
        transitions[tran_length] := i
      else if (abs(Fm[i + 1])<=0.0) then
      begin
        transitions[tran_length] := i + 1;
        i := i + 1;
      end;
      ...
      begin
          ...
          e2 := GetExtremum(Fm, transitions[tran_length - 1],
            transitions[tran_length]);
        if( abs(Fm[transitions[tran_length]] - Fm[transitions[tran_length - 1]])  < 30 )and ( abs(e1.value)<30) and ( abs(e2.value)<20)
        then
        begin                                                                           //  and ( abs(e1.value)<3) and ( abs(e2.value)<3)
         ...
         // if (abs(e1.value) < 10) or  (abs(e2.value) < 10   then
             ...
             or (abs(transitions[tran_length - 2] -transitions[tran_length - 1] ) <30  ))  and ( abs(e1.value)<30) and ( abs(e2.value)<20)
              then
            tran_length := tran_length - 2;
        end;
